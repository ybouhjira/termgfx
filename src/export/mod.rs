//! Export functionality for termgfx output to SVG format
//!
//! This module provides programmatic access to export terminal graphics
//! to standalone SVG files that can be embedded in documents and presentations.
...
/// Export configuration for customizing output
#[derive(Debug, Clone)]
